...
@Component({
  selector: "page-istaffadvise-slide1",
  templateUrl: "istaffadvise-slide1.html"
})
export class IstaffadviseSlide1Page {
  ...
  ngOnInit() {
    this.events.subscribe("istaffadvise:slide0", async (id, key) => {
      this.toggle = id;
      this.queryKey = key;
