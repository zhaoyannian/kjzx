...
export class WorkFlowPage {
  ...
  constructor(public globalData: globalData, public navCtrl: NavController, public navParams: NavParams) {
    this.pointInstStatuss = { waiting: '待处理', inprocess: '启动', complate: '完成', back: '回退' };
  }
  ionViewDidLoad() {
    this.wfHolder()
    this.initSwiper();
