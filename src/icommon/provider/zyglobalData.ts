...
export class zyglobalData {
        ...
        var result = {
            match: (orgList, assignmentFn) => { //　匹配关系自己写
                ...
                return new Promise((resolve, reject) => {
                    // 门户查不到数据
                    return this.http.post(ENV.httpurlzyscm + '/api/dml/queryByMultiConditions/' + clzName, _condis).subscribe(async resp => {
                ...
                // this.http.post(ENV.httpurlzyscm + '/api/dml/queryByMultiConditions/' + clzName, _condis).subscribe( async resp => {
    ...
    transformSimpcg(clzName, ...conditionProducers) {
        var result = {
            match: (orgList, assignmentFn) => { //　匹配关系自己写
                ...
                return new Promise((resolve, reject) => {
                    // 备注：门户域名查不到数据
                    return this.http.post(ENV.httpurlzyscm + '/api/dml/queryByMultiConditions/' + clzName, conds).subscribe(async resp => {
                ...
                // this.http.post(ENV.httpurlzyscm + '/api/dml/queryByMultiConditions/' + clzName, conds).subscribe(async resp => {
    ...
    */
    getWfInstListByBizList(bizList) {
        ...
        return new Promise((resolve, reject) => {
            return this.http.post(ENV.httpurlzyscm + '/api/wf/wfInstFromBusinessKey', bizKeyIds).subscribe(resp => {
                resolve(resp);
            }, error => {
                reject();
            }) // 出错，返回空对象);
    ...
    //         this.http.post(ENV.httpurlzyscm + '/api/wf/wfInstFromBusinessKey', bizKeyIds).subscribe(resp => {
    //           observer.next(resp);
    //         },error =>{
    //           observer.error();
    //         });
    ...
    getWfResourceListByBizList(bizList) {
        ...
        return new Promise((resolve, reject) => {
            return this.http.post(ENV.httpurlzyscm + '/api/wf/resInstFromBusinessKey', bizKeyIds).subscribe(resp => {
                resolve(resp);
            }, error => {
                reject();
            }) // 出错，返回空对象);
    ...
    //     }));
    //     return Observable.create(observer => {
    //       this.http.post(ENV.httpurlzyscm + '/api/wf/resInstFromBusinessKey', bizKeyIds).subscribe(resp => {
    //         observer.next(resp);
    //       },error =>{
    //         observer.error();
    //       });
    ...
    */
    ...
    getWfInfo(uniqueKey, version) {
        return new Promise((resolve, reject) => {
            let uri = ENV.httpurlzyscm + getWfInfoUri + '/' + uniqueKey;
    ...
    getWfInst(wfInstId) {
        return new Promise((resolve, reject) => {
            this.http.get(ENV.httpurlzyscm + getWfInstUri + '/' + wfInstId).subscribe(resp => {
                resolve(resp);
            }, error => {
                reject();
            }) // 出错，返回空对象);
    ...
    getHolderFromResourceNotify(resourceInstId: any): Observable<any> {
        return Observable.create(observer => {
            this.http.get(ENV.httpurlzyscm + '/api/wf/queryWorkflowInfoByNotify' + '/' + resourceInstId).subscribe(resp => {
                let holder = {
   ...
   */
    ...
    getMyNotify(pageInfo, wfAlias, isAllocated, filterParams) {
        ...
        return new Promise((resolve, reject) => {
            return this.http.post(ENV.httpurlzyscm + uri, filterParams, { params: pageInfo }).subscribe(resp => {
                resolve(resp);
            }, error => {
                reject();
            }) // 出错，返回空对象);
    ...
    getNextPointHandleRes(selectResourceListUri, nextPoint) {
        ...
        return new Promise((resolve, reject) => {// 选人
            if (nextPoint.config.modalSelect) {
                this.http.get(ENV.httpurlzyscm + selectResourceListUri).subscribe(resp => {
                    let list = [];
                    list = resp['targetObjects'].data
                    if (list.length > 1) {
                        // 弹出模态框还是怎么选
                        let chooseMOdel = this.modalCtrl.create('SelectPeoplePage', { httpurl:ENV.httpurlzyscm,selectResourceListUri: selectResourceListUri, nextPoint: nextPoint });
    ...
    sendReq(uri, startWorkflowTo) {
        ...
        return new Promise((resolve, reject) => {
            ...
            return new Promise((resolve, reject) => {
                this.http.post(ENV.httpurlzyscm + uri, startWorkflowTo).subscribe(data => {
                    resolve(data)
                },error=>{
                    resolve()
                })
